...
// reserve nodes
config.endpoints = [
      'http://172.31.31.164:8888'
];

// eosjs
config.eosConfig = {
  chainId: "5edba2817f22e78659b946bb040f57306b9046fa8724f9dfd4c9615e4389a9d1",
  keyProvider: "",
...
config.customChain = 'http://172.31.31.164:8888';

// api url for history
config.historyChain = 'http://172.31.31.164:8888';
...
config.blockUpdateTime = 300; // mainpage upades frequency  - /api/api.*.socket in ml sec
